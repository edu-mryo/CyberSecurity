...
Q: What is the security model that assumes no implicit trust and requires continuous verification for all network access?
(1) Zero Trust Architecture
(2) Perimeter-based security
(3) Defense-in-depth
A: (1) Zero Trust Architecture

Q: What is the security approach that focuses on protecting individual resources within a network rather than defending its boundaries?
(1) Deperimeterization
(2) Perimeter-based security
(3) Defense-in-depth
A: (1) Deperimeterization

Q: Which of the following is NOT an essential component of a Zero Trust architecture?
(1) Bring Your Own Device (BYOD)
(2) Identity and access management (IAM)
(3) Network segmentation
A: (1) Bring Your Own Device (BYOD)

Q: What is the principle of using multiple, diverse controls at different levels to provide layered protection in network security?
(1) Defense in depth
(2) Zero Trust
(3) Least privilege
A: (1) Defense in depth

Q: Which type of control is designed to stop security incidents before they happen?
(1) Preventive control
(2) Detective control
(3) Corrective control
A: (1) Preventive control

Q: Which type of control is designed to identify and alert on security incidents?
(1) Preventive control
(2) Detective control
(3) Corrective control
A: (2) Detective control

Q: What is the purpose of endpoint protection software?
(1) To protect individual devices against threats that have bypassed network controls
(2) To control access to cloud-based applications
(3) To balance network traffic loads
A: (1) To protect individual devices against threats that have bypassed network controls