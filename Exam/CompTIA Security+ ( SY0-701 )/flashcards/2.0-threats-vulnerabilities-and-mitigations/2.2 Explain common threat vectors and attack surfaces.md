...
1. A cyber attack that uses disguised email as a weapon
2. A physical attack that uses social engineering to gain access to a building
3. A type of malware that encrypts your files and demands a ransom

A: 1. A cyber attack that uses disguised email as a weapon

Q: What is the goal of a phishing attack?

1. To trick someone into giving up personal information or clicking on a malicious link
2. To install ransomware on a victim's computer
3. To disrupt a company's operations by flooding their network with traffic

A: 1. To trick someone into giving up personal information or clicking on a malicious link
...
1. Registering domain names similar to legitimate ones, hoping users will overlook the typo and visit the malicious site
2. Sending emails with misspelled words to trick victims into clicking on links
3. Using a fake website to collect personal information from victims

A: 1. Registering domain names similar to legitimate ones, hoping users will overlook the typo and visit the malicious site
